...
const Drawer = (props: DrawerProps) => {
  const {setShowSearchPopup, showSearchPopup} = useMainContext()
  const handleCloseSearch = useCallback(() => {
    setShowSearchPopup(false)
  }, [setShowSearchPopup])
  if (!showSearchPopup) return null
  return (
    <div className="w-screen h-screen fixed top-0 bottom-0 right-0 left-0">
      <div className="backdrop absolute w-screen h-screen top-0 bottom-0 right-0 left-0" onClick={handleCloseSearch} />
      {/*<AutoCompleteForm />*/}
