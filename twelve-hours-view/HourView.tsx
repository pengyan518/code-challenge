...
const HoursView: React.FC<IProps> = ({oneHour}) => {
  const {hoursDetail} = useMainContext()
  const {condition, temp_f, time_epoch, time, feelslike_f, wind_mph, wind_dir, humidity, cloud, chance_of_rain} = oneHour
  return (
    <div className="">
          ...
          <div className="Disclosure--SummaryDefault">
            <div className="DetailsSummary grid">
              ...
              <div data-testid="Precip" className="DetailsSummary--precip--1ecIJ">
                <svg
                  className="DetailsSummary--precipIcon"
                  viewBox="0 -2 5 10">
                  <title>Rain</title>
              ...
              <div data-testid="wind" className="DetailsSummary--wind--2rkTO DetailsSummary--extendedData--365A_">
                <svg
                  className="DetailsSummary--conditionsIcon"
                  viewBox="0 0 24 24">
                  <title>Wind</title>
                  <path
            ...
            <svg
              className="Disclosure--SummaryIcon"
              viewBox="0 0 24 24">
